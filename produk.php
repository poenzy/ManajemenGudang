    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active text-black"
                                    aria-current="page" href="tentang.html">
                        ...
                        <div class="pengguna mt-4">
                            ...
                            <ul class="nav flex-column ">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 active text-black"
                                        aria-current="page" href="profile.html">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 active text-black"
                                        aria-current="page" href="user_management.html">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="modal fade" id="modalTambahBarang" tabindex="-1" aria-labelledby="tambahBarangLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="php/produk.php/tambahBarang" method="post">
                                    <div class="kodeBarang">
                                        <label for="kode" class="form-label">Kode Barang</label>
                                        <input type="text" class="form-control" id="kode" name="kode_produk">
                                    </div>
                                    ...
                                    <div class="jumlahStok">
                                        <label for="jumlahStok" class="form-label">Jumlah Stok</label>
                                        <input type="text" class="form-control" id="jumlahStok" name="jumlah_stok">
                                    </div>
                                    <div class="hargaJual">
                                        <label for="harga" class="form-label">Harga Barang</label>
                                        <input type="number" class="form-control" id="harga" name="kategori">
                                    </div>
                                    <div class="kategoriBarang">
                                        <label for="kategori" class="form-label">Kategori Barang</label>
                                        <input type="text" class="form-control" id="kategori" name="kategori">
                                    ...
                                    <div class="fotoProduk">
                                        <label for="foto" class="form-label">Kategori Barang</label>
                                        <input type="text" class="form-control" id="foto" name="foto_produk">
                                    </div>
                                </form>
                            </div>
                ...
                <table class="table table-hover mt-4">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($barang)) {
                            ...
                            echo "<td>";
                            echo "<a href='' class='btn btn-primary me-1'>Ubah</a>";
