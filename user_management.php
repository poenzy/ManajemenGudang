        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="height: 100vh">
                ...
                <table class="table table-hover mt-4">
                    ...
                    <tbody>
                        <?php
                        include 'user/FungsiGetUser.php';
                        $users = getAllUser();
                        if ($users->num_rows > 0) {
                            $i = 1;
                            while ($row = $users->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo    "<form method='post' action='ubah_user.php'>
                                            <input type='hidden' name='id' id='id' value='{$row['id_admin']}'>
                                            <button type='submit' class='btn btn-primary'>Ubah</button>
                                        </form>";
                                echo "<form method='post' action='user/FungsiHapusAdmin.php'>
                                            <input type='hidden' name='id' id='id' value='{$row['id_admin']}'>
