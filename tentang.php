        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="height: 100vh">
                ...
                <div class="about-section">
                    <h2>Visi Kami</h2>
                    <p>
                        Menjadi perusahaan terdepan dalam memberikan solusi digital yang
                        inovatif dan berdampak positif bagi masyarakat.
                    </p>

                    <h2>Misi Kami</h2>
                    <ul>
                        <li>Menghadirkan produk dan layanan berkualitas tinggi.</li>
                        <li>Memberikan pelayanan terbaik kepada pelanggan.</li>
                        <li>Mendukung pengembangan teknologi lokal.</li>
                    </ul>

                    <h2>Sejarah Singkat</h2>
                    <p>
                        Kami didirikan pada tahun 2025 dengan tujuan membantu UMKM dan
                        perusahaan dalam transformasi digital. Sejak saat itu, kami terus
                        berkembang dan telah melayani lebih dari 500 klien dari berbagai
                        sektor industri.
                    </p>
                    ...
                    <p>
                        ...
                        teknologi, desain, dan pelayanan pelanggan yang berdedikasi untuk
